        ...
        <div className="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <CSSTransition in={state.username.hasErrors} timeout={330} classNames="liveValidateMessages" unmountOnExit>
            ...
            <div className="form-group">
              ...
              <CSSTransition in={state.email.hasErrors} timeout={330} classNames="liveValidateMessages" unmountOnExit>
            ...
            <div className="form-group">
              ...
              <CSSTransition in={state.password.hasErrors} timeout={330} classNames="liveValidateMessages" unmountOnExit>
